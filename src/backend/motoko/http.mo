// We only use the statuscodes, because we switched to ic-py for calling canister methods.

// From: https://raw.githubusercontent.com/aviate-labs/http.mo/main/src/Http.mo
//       https://github.com/aviate-labs/http.mo/blob/main/src/Query.mo
...
module {
    ...
    public module Status {
        ...
        public let Unauthorized                 : StatusCode = 401; // RFC 7235, 3.1    https://stackoverflow.com/questions/3297048/403-forbidden-vs-401-unauthorized-http-responses
    ...
    // public func response_json(h: HashMap.HashMap<Text, Json.JSON>) : Response {
    //     return {
    //         body = Text.encodeUtf8(Json.show(#Object(h)));
    //         headers = [("Content-Type", "application/json; charset=utf-8")];
    //         status_code = Status.OK : Nat16; // 200
    //         streaming_strategy = null;
    //     };
    // };

    // public func response_401_unauthorized() : Response {
    //     return {
    //         body = Text.encodeUtf8("");
    //         headers = [("WWW-Authenticate:", "Login with Internet Identity first")];
    //         status_code = Status.Unauthorized : Nat16;  // 401
    //         streaming_strategy = null;
    //     };
    // };
    ...
    // public func url_split(str: Text): Result.Result<(Text, [Field]), Text> {
